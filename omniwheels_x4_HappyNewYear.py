...
# forked from omniwheels_x4_write
# writes and paints new years greetings on DIN A4 sheet
# Mechatronics: omniwheels_x4_paint ("Malroboter") as described in fischertechnik high tech robotics manual
...
size = 4		# horizontal step size in mm (vertical step size is factor 1.5 longer)
...
simplex = {
    ...
    'space': 'R 6',
    'heart': 'P 1;UL 20;U 12;UR 5;R 10;DR 5;UR 5;R 10;DR 5;D 12;DL 20;P 0'		# special sequence for surrounding heart
}
...
def write_string(string):
    for letter in string:
        if letter.isalpha():
            if letter.isupper():
                write_letter(letter.lower()+'_upper')
            else:
                write_letter(letter+'_lower')
        elif letter==' ':
            write_letter('space')
